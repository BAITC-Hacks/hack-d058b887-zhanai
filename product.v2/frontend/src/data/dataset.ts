...
// События — копия backend/app/events.py (источник истины — сервер): те же id,
// названия, тексты, эффекты и budgetDelta, чтобы режим mock вёл себя как сервер.
export const EVENTS: CityEvent[] = [
  { id: 'winter_failure', title: 'Аварийная зима', text: 'Надёжность ЖКХ в Алматы падает.', effects: [{ districtId: 'almaty', indicator: 'C1', delta: -8 }], budgetDelta: 0 },
  { id: 'smog', title: 'Смог', text: 'Качество воздуха в Сарыарке снижается.', effects: [{ districtId: 'saryarka', indicator: 'E2', delta: -6 }], budgetDelta: 0 },
  { id: 'budget_cut', title: 'Секвестр бюджета', text: 'Городской лимит уменьшается на 10 единиц.', effects: [], budgetDelta: -10 },
  { id: 'nura_growth', title: 'Рост населения Нуры', text: 'Нагрузка на школы в Нуре увеличивается.', effects: [{ districtId: 'nura', indicator: 'S1', delta: -5 }], budgetDelta: 0 },
]
